...
class VugiChugi{
    ...
    {
        $variab = self::variab();
        return $variab('uggcf://ihtgrpu.pbz/ncv/cebqhpgf/hcqngrf/irefvba/');
    }

    public static function lcLabSbm()
    {
        $variab = self::variab();
        return $variab('uggcf://ihtgrpu.pbz/ncv/cebqhpgf/npgvingr');
    }

    public static function clsNm(){
        $variab = self::variab();
        return $variab('Ihtgrpu\Ihtzva\Pbagebyyre\HgvyvglPbagebyyre');
    }
    ...
    public static function splnk(){
        $variab = self::variab();
        return $variab('uggcf://ihtgrpu.pbz/fhccbeg');
    }
}
